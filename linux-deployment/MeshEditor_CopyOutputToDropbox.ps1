...
robocopy "C:/Projects/MeshEditor/MeshEditor.FormatConverter.Console/bin/Release" "C:/Users/benes/Dropbox/Ubuntu/mesheditor/package/usr/lib/mesheditor" *.dll *.exe *.config /xf *.vshost.exe *.vshost.exe.config
