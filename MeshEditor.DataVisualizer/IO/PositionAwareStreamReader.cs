...
{
	/// <summary>
	/// Reads text files line by line, with exact offset/position reporting.
	/// See: http://www.daniweb.com/software-development/csharp/threads/35078/streamreader-and-position
	/// </summary>
	[Serializable]
	public class PositionAwareStreamReader : TextReader
	{
		public new static readonly PositionAwareStreamReader Null = new NullPositionAwareStreamReader();
		...
		// ------------------------------------------------------------------
		// Set exact position in underlying stream
		...
		{
			DiscardBufferedData(); // should not be called often - is expensive
			BaseStream.Seek(position, SeekOrigin.Begin);
			_bytesRead = position;
		}
		// ------------------------------------------------------------------

		internal PositionAwareStreamReader()
		{
		}
		...
		public PositionAwareStreamReader(Stream stream, bool detectEncodingFromByteOrderMarks)
		...
		public PositionAwareStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks)
			: this(stream, encoding, detectEncodingFromByteOrderMarks, DefaultBufferSize)
		{
		}
		public PositionAwareStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize)
		{
		...
		public PositionAwareStreamReader(String path)
		...
		public PositionAwareStreamReader(String path, bool detectEncodingFromByteOrderMarks)
			: this(path, Encoding.UTF8, detectEncodingFromByteOrderMarks, DefaultBufferSize)
		{
		}
		/// <include file='doc\myStreamReader.uex' path='docs/doc[@for="myStreamReader.myStreamReader5"]/*' />
		public PositionAwareStreamReader(String path, Encoding encoding)
			: this(path, encoding, true, DefaultBufferSize)
		{
		}
		/// <include file='doc\myStreamReader.uex' path='docs/doc[@for="myStreamReader.myStreamReader6"]/*' />
		public PositionAwareStreamReader(String path, Encoding encoding, bool detectEncodingFromByteOrderMarks)
			: this(path, encoding, detectEncodingFromByteOrderMarks, DefaultBufferSize)
		{
		}
		/// <include file='doc\myStreamReader.uex' path='docs/doc[@for="myStreamReader.myStreamReader7"]/*' />
		public PositionAwareStreamReader(String path, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize)
		{
		...
		private class NullPositionAwareStreamReader : PositionAwareStreamReader
		{
