namespace MeshEditor.DataVisualizer.UI
{
	partial class SolutionBrowserForm
	{
		...
		{
			this.listBoxRemoteSolutions = new System.Windows.Forms.ListBox();
			...
			this.listBoxLocalSolutions = new System.Windows.Forms.ListBox();
			...
			this.buttonBrowseLocalSolutions = new System.Windows.Forms.Button();
			this.tabControl.SuspendLayout();
			this.tabPageLocalSolutions.SuspendLayout();
			this.tabPageRemoteSolutions.SuspendLayout();
			this.SuspendLayout();
			// 
			// listBoxRemoteSolutions
			// 
			this.listBoxRemoteSolutions.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.listBoxRemoteSolutions.FormattingEnabled = true;
			this.listBoxRemoteSolutions.Location = new System.Drawing.Point(6, 6);
			this.listBoxRemoteSolutions.Name = "listBoxRemoteSolutions";
			this.listBoxRemoteSolutions.Size = new System.Drawing.Size(395, 212);
			this.listBoxRemoteSolutions.TabIndex = 0;
			this.listBoxRemoteSolutions.SelectedIndexChanged += new System.EventHandler(this.listBoxRemoteSolutions_SelectedIndexChanged);
			this.listBoxRemoteSolutions.DoubleClick += new System.EventHandler(this.listBoxRemoteSolutions_DoubleClick);
			// 
			// buttonOk
			// 
			...
			this.buttonCancel.Location = new System.Drawing.Point(330, 283);
			...
			this.buttonRemoteSolutionOpenInBrowser.Location = new System.Drawing.Point(6, 221);
			...
			this.tabControl.Size = new System.Drawing.Size(415, 276);
			this.tabControl.TabIndex = 4;
			this.tabControl.SelectedIndexChanged += new System.EventHandler(this.tabControl_SelectedIndexChanged);
			// 
			// tabPageLocalSolutions
			// 
			this.tabPageLocalSolutions.Controls.Add(this.buttonBrowseLocalSolutions);
			this.tabPageLocalSolutions.Controls.Add(this.buttonDeleteLocalSolution);
			this.tabPageLocalSolutions.Controls.Add(this.listBoxLocalSolutions);
			...
			this.tabPageLocalSolutions.Size = new System.Drawing.Size(407, 250);
			...
			this.buttonDeleteLocalSolution.Location = new System.Drawing.Point(326, 221);
			...
			// 
			// listBoxLocalSolutions
			// 
			this.listBoxLocalSolutions.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.listBoxLocalSolutions.FormattingEnabled = true;
			this.listBoxLocalSolutions.Location = new System.Drawing.Point(6, 6);
			this.listBoxLocalSolutions.Name = "listBoxLocalSolutions";
			this.listBoxLocalSolutions.Size = new System.Drawing.Size(395, 212);
			this.listBoxLocalSolutions.TabIndex = 0;
			this.listBoxLocalSolutions.SelectedIndexChanged += new System.EventHandler(this.listBoxLocalSolutions_SelectedIndexChanged);
			this.listBoxLocalSolutions.DoubleClick += new System.EventHandler(this.listBoxLocalSolutions_DoubleClick);
			// 
			// tabPageRemoteSolutions
			// 
			this.tabPageRemoteSolutions.Controls.Add(this.buttonDeleteRemoteSolution);
			this.tabPageRemoteSolutions.Controls.Add(this.listBoxRemoteSolutions);
			...
			this.tabPageRemoteSolutions.Size = new System.Drawing.Size(407, 250);
			...
			this.buttonDeleteRemoteSolution.Location = new System.Drawing.Point(326, 221);
			...
			// 
			// buttonBrowseLocalSolutions
			// 
			this.buttonBrowseLocalSolutions.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.buttonBrowseLocalSolutions.Location = new System.Drawing.Point(6, 221);
			this.buttonBrowseLocalSolutions.Name = "buttonBrowseLocalSolutions";
			this.buttonBrowseLocalSolutions.Size = new System.Drawing.Size(75, 23);
			this.buttonBrowseLocalSolutions.TabIndex = 3;
			this.buttonBrowseLocalSolutions.Text = "Browse...";
			this.buttonBrowseLocalSolutions.UseVisualStyleBackColor = true;
			this.buttonBrowseLocalSolutions.Click += new System.EventHandler(this.buttonBrowseLocalSolutions_Click);
			// 
			// SolutionBrowserForm
			// 
		...
		private System.Windows.Forms.ListBox listBoxRemoteSolutions;
		...
		private System.Windows.Forms.ListBox listBoxLocalSolutions;
		...
		private System.Windows.Forms.Button buttonBrowseLocalSolutions;
	}
}