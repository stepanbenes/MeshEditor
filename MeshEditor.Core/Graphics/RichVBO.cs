...
namespace MeshEditor.Graphics
{
	...
	/// </summary>
	public class RichVBO : IVertexBufferObject
    {
		...
		{
			IntPtr videoMemory;
			if (!MapBuffer(BufferTarget.ArrayBuffer, this.normalBufferID, BufferAccess.ReadWrite, out videoMemory))
				return;
			// -----------------
			unsafe
			{
