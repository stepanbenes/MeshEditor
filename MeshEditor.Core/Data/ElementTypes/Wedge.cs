...
namespace MeshEditor.Data
{
	...
	public class Wedge : Element3D
	{
		...
		public override IEnumerable<Element2D> GenerateAllFaces(Dictionary<EdgeMark, Node> quadraticNodesCache)
		{
			...
			face = GenerateFaceWithNodes(1, ref center, nodes[2], nodes[1], nodes[4], nodes[5]);
			if (face != null)
			{
				if (quadratic)
				{
			...
			face = GenerateFaceWithNodes(2, ref center, nodes[0], nodes[2], nodes[5], nodes[3]);
			if (face != null)
			{
				if (quadratic)
				{
			...
			face = GenerateFaceWithNodes(4, ref center, nodes[0], nodes[1], nodes[2]);
			if (face != null)
			{
				if (quadratic)
				{
			...
			face = GenerateFaceWithNodes(5, ref center, nodes[3], nodes[5], nodes[4]);
			if (face != null)
			{
				if (quadratic)
				{
