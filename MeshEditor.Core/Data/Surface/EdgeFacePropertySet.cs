...
namespace MeshEditor.Data
{
	...
	/// </summary>
	public class EdgeFacePropertySet
	{
		...
		public EdgeFacePropertySet(EdgeFacePropertySet toCopy)
		{
			this.triangleProperties = new Dictionary<TriangleMark, Property>(toCopy.triangleProperties);
			this.quadProperties = new Dictionary<QuadMark, Property>(toCopy.quadProperties);
			this.edgeProperties = new Dictionary<EdgeMark, Property>(toCopy.edgeProperties);
		}
